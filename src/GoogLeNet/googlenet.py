...
def define_model(input_shape=(224, 224, 3), num_classes=1000, weight_path = None):
    ...
    flat = Flatten()(drop1)
    linear = Dense(units=num_classes, activation='softmax', kernel_regularizer=l2(0.01))(flat)
    last = linear
