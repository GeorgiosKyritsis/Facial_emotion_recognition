...
import numpy as np
import os
from googlenet import define_model
...
# Real time augmentation and normalization
...
model = define_model(input_shape=(img_rows,img_cols,img_channels), num_classes=nb_classes)
# set the optimizer -> SGD
