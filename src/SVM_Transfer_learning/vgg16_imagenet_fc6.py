...
X_train, Y_train = create_dataset('../../data/transfer_learning/VGG16_ImageNet_fc6/Train/', '../../data/ferplus/Train48/')
X_valid, Y_valid = create_dataset('../../data/transfer_learning/VGG16_ImageNet_fc6/Valid/', '../../data/ferplus/Valid48/')
X_test, Y_test = create_dataset('../../data/transfer_learning/VGG16_ImageNet_fc6/Test/', '../../data/ferplus/Test48/')
