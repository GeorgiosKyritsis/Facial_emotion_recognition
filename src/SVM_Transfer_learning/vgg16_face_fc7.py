...
X_train, Y_train = create_dataset('../../data/transfer_learning/VGG16_Face_fc7/Train/', '../../data/ferplus/Train48/')
X_valid, Y_valid = create_dataset('../../data/transfer_learning/VGG16_Face_fc7/Valid/', '../../data/ferplus/Valid48/')
X_test, Y_test = create_dataset('../../data/transfer_learning/VGG16_Face_fc7/Test/', '../../data/ferplus/Test48/')
